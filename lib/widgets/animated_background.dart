    ...
    return Container(
      decoration: const BoxDecoration(
        ...
        gradient: RadialGradient(
          ...
          radius: 1.2,
          colors: [Color(0xFF3D1566), Color(0xFF190831)],
          stops: [0.0, 1.0],
        ),
      ),
    );
...
class _CircleAnimation {
  ...
  _CircleAnimation(this.index, this.vsync) {
    ...
    ).animate(CurvedAnimation(parent: _controllerX, curve: Curves.easeInOut));
    _animY = Tween<double>(
      begin: startY,
      end: endY,
    ).animate(CurvedAnimation(parent: _controllerY, curve: Curves.easeInOut));
